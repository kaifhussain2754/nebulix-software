...
const techStackItems = [
  { name: 'React.js', imgSrc: './icons/react.svg' },
  { name: 'Node.js', imgSrc: './icons/nodejs.png' },
  { name: 'Express.js', imgSrc: './icons/express.svg' },
  { name: 'MongoDB', imgSrc: './icons/mongodb.svg' },
  { name: 'SQL', imgSrc: './icons/sql.svg' },
  { name: 'Swift', imgSrc: './icons/swift.svg' },
  { name: 'Java', imgSrc: './icons/java.png' },
  { name: 'PHP', imgSrc: './icons/php.png' },
  { name: 'MaterialUI', imgSrc: './icons/material-ui-1.svg' },
  { name: 'Bootstrap', imgSrc: './icons/bootstrap.png' },
  { name: 'HTML', imgSrc: './icons/html.png' },
  { name: 'CSS', imgSrc: './icons/css-3.png' },
  { name: 'JavaScript', imgSrc: './icons/js.png' },
  { name: 'Adobe Illustrator', imgSrc: './icons/illustrator.png' },
  { name: 'Figma', imgSrc: './icons/figma.png' },
  { name: 'Photoshop', imgSrc: './icons/photoshop.png' },
  { name: 'Premiere Pro', imgSrc: './icons/premiere-pro.png' },
  { name: 'After Effects', imgSrc: './icons/after-effects.png' },
];
